...
<div class="page-content">
                ...
                <div class="card">
							<div class="card-body p-4">
                                ...
                                <form class="row g-3" action="{{route('update.course')}}" method="post" id="courseForm" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <option value="{{$catlist->id}}"{{$catlist->id == $course->category_id ? 'selected' : '' }}>{{$catlist->category_name}}</option>
                                        @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <option value="{{$subc->id}}"{{$subc->id == $course->sub_category_id ? 'selected' : '' }}>{{$subc->sub_category_name}}</option>
                                        @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <option selected="" disabled>Choose yes or no</option>
                                        <option value="Beginner"{{ $course->label == 'Beginner' ? 'selected' : ''}}>Beginner-level</option>
                                        <option value="Intermediate"{{ $course->label == 'Intermediate' ? 'selected' : ''}}>Intermediate-level</option>
                                        <option value="Advanced"{{ $course->label == 'Advanced' ? 'selected' : ''}}>Advanced-level</option>
                                        </select>
									</div>

                                    <div class="form-group col-md-3">
										<label for="input1" class="form-label">Course Price</label>
										<input type="text" class="form-control" name="selling_price" id="selling_price" value="{{$course->selling_price}}">
									</div>

                                    <div class="form-group col-md-3">
										<label for="input1" class="form-label">Discount Price</label>
										<input type="text" class="form-control" name="discount_price" id="discount_price" value="{{$course->discount_price}}">
									</div>
                                    ...
                                    <div class="form-group col-md-3">
										...
										<input type="text" class="form-control" name="resources" id="resources" value="{{$course->resources}}">
									</div>
							...
							<div class="card-body">
                                <form action="{{route('update.course.image')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                        <img id="showImage" src="{{asset($course ->course_image)}}" alt="" class="rounded-circle p-1 bg-primary" width="100">
                                        </div>
                                    </div><br>
                                    <div class="col-md-12">
										<div class="d-md-flex d-grid align-items-center gap-3">
